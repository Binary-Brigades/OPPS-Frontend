      ...
      <>
        ...
        <div className="relative w-screen h-screen  gap-5 bg-gray-200 px-5 py-5 flex flex-col items-center justify-center rounded-xl ">
          <div className="rounded-tr-xl rounded-br-xl md:rounded-tr-none w-[99%] h-[600px] md:h-[95%] flex  items-center  shadow-xl shadow-slate-400 mt-5 flex-row-reverse">
            <div className="flex  justify-center items-center w-full h-[100%] flex-1 bg-[#fff] rounded-xl   md:rounded-tl-none relative">
              <form
              ...
              >
                ...
                <div className=" ml-[50px] md:ml-[30px] w-full text-s">
                  <p className="text-left  text-md w-full mt-[10px]">
                    Welcome back! Please fill in your credentials...
                  </p>
                </div>
                <div className="flex flex-col justify-center w-[90%] text-start mt-[-30px]">
